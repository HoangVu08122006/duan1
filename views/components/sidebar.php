<div class="sidebar">
    ...
    <ul class="menu">
        ...
        <li><a href="index.php?act=danhSachNhanSu">Danh sách nhân sự</a></li>
        <li><a href="index.php?act=dieuHanhTour">Điều hành tour</a></li>
        <li><a href="index.php?act=quanLyDoanKhach">Quản lý đoàn khách</a></li>
        <li><a href="index.php?act=ghiChu">Ghi chú khách hàng</a></li>
